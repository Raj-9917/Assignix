...
/**
 * Pixel class handles individual pixel animation logic.
 */
class Pixel {
...
/**
 * Custom Web Component for handling high-performance rendering of many pixels.
 */
...
/**
 * PixelCanvas React Wrapper Component
 */
export const PixelCanvas = forwardRef(({ gap, speed, colors, variant, noFocus, className, style, ...props }, ref) => {
  useEffect(() => {
    // Register web component on mount
